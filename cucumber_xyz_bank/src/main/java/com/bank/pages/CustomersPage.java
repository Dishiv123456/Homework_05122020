...
public class CustomersPage extends Utility {
    ...
    public void clickOnCustomerBtn() {
        Reporter.addStepLog("clicking on customers btn " + _customersBtn.toString() + "<br>");
    ...
    public void clickOnHomeBtn() {
        Reporter.addStepLog("clicking on home btn " + _homeBtn.toString() + "<br>");
    ...
    public void clickOnLogoutBtn() {
        ...
        Reporter.addStepLog("clicking on logout btn " + _logoutBtn.toString() + "<br>");
    ...
    //This method to verify logout btn
        ...
        public boolean isLogoutDisplayed() {
            Reporter.addStepLog("verification of logout btn " + _logoutBtn.toString() + "<br>");
