...
public class BankManagerLoginPage extends Utility {
    ...
    public void clickOnAddCustomerLink() {
        Reporter.addStepLog("clicking on add customer link " + _addCustomerLink.toString() + "<br>");
    ...
    public void clickOnOpenAccountBtn() {
        Reporter.addStepLog("clicking on open account btn " + _openAccountBtn.toString() + "<br>");log.info("clicking on open account btn " + _openAccountBtn.toString());
